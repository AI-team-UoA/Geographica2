					...
					<tr>
						...
						<td>
							<input type="radio" id="useLazyAdd"
								name="Enable using batch optimization" size="48" value="true" checked="true" />
							<xsl:value-of select="$true.label" />
							<input type="radio" id="useLazyAdd"
								name="Enable using batch optimization" size="48" value="false" />
					...
					<tr>
						...
						<td>
							<input type="radio" id="useDefGraphForQueries"
								name="Use defGraph for Queries" size="48" value="true" checked="true"/>
							<xsl:value-of select="$true.label" />
							<input type="radio" id="useDefGraphForQueries"
								name="Use defGraph for Queries" size="48" value="false" />
							<xsl:value-of select="$false.label" />
						</td>
						<td></td>
					</tr>
